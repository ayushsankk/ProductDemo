...
public class Main {
    public static void main(String[] args) {
        ...
        Stream<Product> prodsByPlace = service.getProductByPlace("white Table");
        prodsByPlace.forEach(product -> System.out.println(product));

        System.out.println("==============================================");
        System.out.println("Get Products that are out of warranty");
        Stream<Product> outOfWarrantyProducts = service.getOutOfWarrantyProducts();
